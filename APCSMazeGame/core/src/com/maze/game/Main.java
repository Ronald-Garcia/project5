...
public class Main extends Game {
	...
	/*
	 * This method initializes all the instance variables and loads the menu page and the maze
	 */
	@Override
	public void create() {
	...
	/*
	 * This method was used for bug testing, hitting 1 2 3 4 5 will take you to map 1 2 3 4 5 respectively, and it also renders the maze
	 */
	@Override
	public void render() {
	...
	/*
	 * This method disposes the map and maze once the window is closed
	 */
	@Override
	public void dispose () {
		batch.dispose();
	...
	/*
	 * This method loads the specified map, changing the maze specifications to the new maze
	 */
	...
	/*
	 * This method resets the current maza
	 */
	...
	/*
	 * This method moves onto the next maze in the array
	 */
